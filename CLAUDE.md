...
- `docs/Scrivi_Linux_Rig_Setup_v0_1.md` — **the runnable steps that stand up a native Linux test rig**
  (EP-038 / SP-123). Written **as-run** on 2026-08-29, not reconstructed. Covers access (RDP + the four
  things that each blocked it once, including ⚠️ **Right-Shift+D silently disconnecting the session**),
