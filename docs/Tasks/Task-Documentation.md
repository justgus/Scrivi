...
Currently: **43 backlog Tasks** — newest: **T-0294–T-0297** (EP-023/SP-073 chapter drag-reorder + Epic
verify/close, defined at SP-073 planning 2026-07-19; full rows in `Task-backlog.md`). *(Table below lags a
re-audit; `Task-backlog.md` is the authoritative backlog list.)*
...
Currently: **0 active Tasks.** SP-066 (EP-023 `[Linux]` rename scene/chapter) ✅ closed 2026-07-15; its tasks
**T-0254–T-0257** are all ✅ Verified & archived to `Verified/Task-verified-0254-0257.md` (delivered EP-023 AC3
+ closed I-0062). **EP-023 remains Active** — its next sprint (**SP-067**, scene reorder + I-0064 chapter-split
+ I-0063 renumber) and tasks are defined at planning.

> **Cleanup (2026-07-15, SP-066/EP-023 close):** T-0254–T-0257 archived to
> `Verified/Task-verified-0254-0257.md`.
>
> **Cleanup (2026-07-15, SP-065 close):** T-0250–T-0253 archived to
> `Verified/Task-verified-0250-0253.md` (delivered EP-023 AC1 + AC2).
>
...
- **Next available:** **T-0407** (as of 2026-08-12). T-0370–T-0391 are EP-031's planned tasks; T-0392–T-0400
  ...
  **T-0402** at SP-096 planning (endpoint-kind resolution), **T-0403** + **T-0404** at SP-097 planning
  ...
  (I-0113 ABI widen; `source` kind). _NB: the aggregate counts above predate a full re-audit and
...
- **EP-031 SP-095 (delivered 2026-08-12):** T-0370, T-0371, T-0372, **T-0401** — all ✅ **Verified
  ...
  **439/439 Linux (GCC 14)**, interop **59 passed / 0 failed**. **T-0365** (`sources` card + `source` kind)
  is 🔵 **Backlog, unblocked 2026-08-12** — OQ-1 closed by a design amendment (Doc 1 §3.4, Doc 2 §3.1.1);
  splits ScriviCore → SP-096/098 and card → SP-099. Source-in-manuscript deferred to **EP-032**.
- **EP-031 SP-098 (delivered 2026-08-12, sprint ✅ closed):** **T-0405**, **T-0380**, **T-0377**, **T-0378**,
  **T-0379**, **T-0406** — all ✅ **Verified (user-approved 2026-08-12)**, plus **I-0113** Resolved-Verified.
  Graph integrity: cascade-prune on object/scene/chapter delete + load-time repair, orphan queries,
  `objectID`-preserving promotion with the edge log **byte-identical**, and ⚠️ **pending-vs-dangling**
  (*absence is never deletion*). ctest **510/510 macOS** + **517/517 Linux (GCC 14.2, zero warnings)**,
  interop **56 passed / 0 failed**; **33 new tests, all through `scrivi_*`** rather than the C++ facade —
  a facade-only test cannot see a boundary gap, which is exactly how I-0113 shipped.
  **EP-031 AC1 + AC4 + AC7 met (8 of 10).** With **T-0406**, T-0365 is now two thirds done — only the
  aggregate `sources` card remains, in SP-099.
...
*Last Updated: 2026-07-19 (**T-0294–T-0297 defined at SP-073 planning** — EP-023 `[Linux]` chapter
