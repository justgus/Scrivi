...
- Created `src/platform/AppSupportLayout.hpp/.cpp` (moved from `src/util/`)
- Deleted `src/util/AppSupportLayout.hpp/.cpp`
- Updated `src/public_api/ScriviCore.cpp` include path
