...
| **SP-144** | ⚠️ **`[Cross]`** **Project open cost** — ⚠️ **[I-0231] read amplification (~370×) + [I-0232] Linux landing open blocks the UI 155 s** | ⚠️ **EP-042** `[Cross]` | — | — | 🔵 **Planned** → [record](Sprint-SP-144.md) |
