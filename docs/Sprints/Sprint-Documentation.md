...
✅ **EP-034 CLOSED 2026-08-25**; **EP-035** and **EP-038** run in parallel.
...
| **SP-140** | ⚠️ **`[Apple]`** Stop discarding unknown `inspector-layout.json` keys — [I-0215] | EP-040 `[Apple]` | — | — | 🔵 **Planned** → [record](Sprint-SP-140.md) |
| **SP-141** | ⚠️ **`[Apple]`+`[ScriviCore]`** Core-owned `inspector-layout.json` — endpoints + Apple | EP-040 `[Apple]` | — | — | 🔵 **Planned** → [record](Sprint-SP-141.md) |
| **SP-142** | ⚠️ **`[Linux]`** Retire the duplicate `InspectorLayoutStore` | EP-040 `[Apple]` | — | — | 🔵 **Planned** → [record](Sprint-SP-142.md) |
| **SP-143** | ⚠️ **`[Cross]`** The regression guard — closes [I-0197] | EP-040 `[Apple]` | — | — | 🔵 **Planned** → [record](Sprint-SP-143.md) |
