...
🟡 **SP-133 is ACTIVE** — `[Apple]` **TextKit 2** (T-0525–T-0531).
⚠️ **Its Epic [EP-039] CLOSED 2026-09-15** — ✅ **the Sprint's verified Tasks (T-0525/6/7, T-0532,
T-0534) are archived** → [`../Tasks/Verified/Task-verified-0525-0534.md`](../Tasks/Verified/Task-verified-0525-0534.md).
⚠️ **SP-133 itself is NOT closed: [T-0528], [T-0530] and [T-0531] reached conclusions but were never
user-verified, and ⚠️ [T-0529] is delivered-but-unverified.** ✅ **Closing it needs user approval.**

✅ **CLOSED 2026-09-15 (user-approved):** ✅ **[SP-131]** → [`Closed/Sprint-SP-131.md`](Closed/Sprint-SP-131.md)
· ✅ **[SP-132]** → [`Closed/Sprint-SP-132.md`](Closed/Sprint-SP-132.md).

🟡 **EP-040 IS NOW ACTIVE** — `[Apple]` **The Editor Shell.** ✅ **Its first Sprint is SP-134
(S1+S2, the toolbar).** ⚠️ **NOT YET CREATED — ✅ see [EP-040]'s Sprint table.**

✅ **Next available Sprint ID: SP-134 · next available Task: T-0535.**

⚠️ **WHERE THINGS STAND (2026-09-15):** ✅ **Project open is DONE and measured: `~300 s` → `0.34 s`
on 1,174 scenes.** ✅ **The app is USABLE — the 33 s timeline stall and the focus-click beachball are
both gone.** ⚠️ **WHAT REMAINS IS SHAPE, NOT SPEED:** ⚠️ **the window has no `NSToolbar`, the bars are
`VStack` siblings, and the Inspector hand-rolls a column** — ✅ **that is [EP-040].**
⚠️ **TWO PERFORMANCE DEFECTS ARE CARRIED, NOT FIXED: [I-0206]** (offset-linear `setSel`, `57–81 ms`
near the document end) **and [I-0213]** (chapter create `~305 ms`).
