...
**Status:** 🟡 **Active** — **10 of 11 sprints closed; SP-100 (the last) is 🟡 ACTIVE as of 2026-08-19.** SP-095 ✅ (**AC2**), SP-096 ✅ (**AC5**),
...
- [ x] AC1 — ⚠️ **AMENDED 2026-08-19 at SP-100 planning (user-approved, ruling R1).** Its verified form is now:
...
- [x ] AC10 — ⚠️ **AMENDED 2026-08-19 at SP-100 planning (user-approved, ruling R2).** Its verified form is now:
...
| T-0390 | External Change Repair Matrix — world-package conditions (⚠️ matrix had **ZERO** world coverage)                                                     | SP-100            | 🟠 **Implemented - Not Verified (2026-08-19)**                                                            |
| T-0418 | ⚠️ **Live-use pass on the real rig** — 10 world kinds, relate, eject/reattach, reopen (**new at SP-100 planning, R4**)                               | SP-100            | 🟠 **Run 2026-08-19 - Not Verified** — ⚠️ AC23 **held**; steps 1–2 partially blocked                      |
| T-0391 | EP-031 verification (AC1–AC10) + Epic close prep — ⚠️ **amends AC1 + AC10 before verifying them**                                                    | SP-100            | 🟠 **Implemented - Not Verified (2026-08-19)**                                                            |
